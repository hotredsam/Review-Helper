...
## Tasks
- [ ] **T1 Context bundle** — assemble ProjectContext (plan + decisions + answers + stack) for model calls. Done when: a unit test builds a bundle from seeded rows and from an empty project.
