...
## Tasks
- [ ] **T1 Question generation** — bank supplies the topic/dimension; the model writes repo-specific question text + a recommended answer. Done when: generation yields repo-specific questions, each with a recommended answer, tagged by dimension.
