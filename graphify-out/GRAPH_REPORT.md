...
## Corpus Check
- 231 files · ~124,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1983 nodes · 3976 edges · 134 communities (129 shown, 5 thin omitted)
...
Cohesion: 0.08
Nodes (28): Command, augmented_path(), check_available(), classifies_credit_exhaustion(), classify_result(), classify_stderr(), ClaudeCodeProvider, extra_path_dirs() (+20 more)
...
Cohesion: 0.09
Nodes (28): getModelStatus(), ModelEvent, ModelStatus, onModelEvent(), runModel(), UnavailableReason, getModelConfig(), ModelConfig (+20 more)
...
Cohesion: 0.15
Nodes (18): EmptyState(), EmptyStateProps, MainPane(), Props, MODES, ModeToggle(), RepoCache(), Props (+10 more)
...
Cohesion: 0.18
Nodes (16): Subject, subjectCreate(), subjectDelete(), SubjectDetail, subjectGet(), subjectsList(), LearningShell(), STAGE_LABEL (+8 more)

### Community 33 - "Community 33"
Cohesion: 0.16
Nodes (18): Arc, LearningGate, subject_create(), subject_delete(), subject_get(), subjects_list(), Mutex, app_info() (+10 more)
...
Cohesion: 0.16
Nodes (10): Client, SettingsView(), ThemeSwitcher(), backend, isThemeId(), ThemeId, ThemeMeta, THEMES (+2 more)
...
Cohesion: 0.29
Nodes (6): Tour(), TOUR_STEPS, tourSeen(), TourStep, App(), NoticeBar()
...
Cohesion: 0.21
Nodes (8): commands, description, identifier, commands, description, identifier, allow-set-as-app-menu, deny-get
...
## Knowledge Gaps
- **543 isolated node(s):** `guard-commit.sh script`, `PreToolUse`, `recommendations`, `name`, `private` (+538 more)
...
- **Why does `init_connection()` connect `Community 10` to `Community 1`, `Community 35`, `Community 37`, `Community 38`, `Community 7`, `Community 39`, `Community 8`, `Community 5`, `Community 43`, `Community 12`, `Community 14`, `Community 17`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `memory_db()` connect `Community 1` to `Community 10`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Are the 20 inferred relationships involving `init_connection()` (e.g. with `db()` and `db()`) actually correct?**
  _`init_connection()` has 20 INFERRED edges - model-reasoned connections that need verification._
