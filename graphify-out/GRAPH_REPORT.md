...
## Corpus Check
- 223 files · ~120,026 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1924 nodes · 3837 edges · 133 communities (128 shown, 5 thin omitted)
...
5. `String` - 26 edges
6. `init_connection()` - 25 edges
7. `Result` - 18 edges
8. `http_client()` - 18 edges
9. `useUiStore` - 18 edges
10. `String` - 17 edges
...
Cohesion: 0.10
Nodes (38): db(), detect_tech_in_clone(), detects_tech_from_manifests_with_word_boundaries(), is_word_char(), mentions(), refuses_symlinked_manifest_escaping_the_clone(), AuditEntry, key() (+30 more)
...
Cohesion: 0.13
Nodes (18): ComingSoon(), EmptyState(), EmptyStateProps, MainPane(), Props, ModelDebug(), SettingsView(), Props (+10 more)
...
Cohesion: 0.17
Nodes (12): InfoDot(), ModelBanner(), Tour(), TOUR_STEPS, tourSeen(), TourStep, App(), useStatusStore (+4 more)
...
## Knowledge Gaps
- **532 isolated node(s):** `guard-commit.sh script`, `PreToolUse`, `recommendations`, `name`, `private` (+527 more)
...
- **Why does `init_connection()` connect `Community 10` to `Community 34`, `Community 35`, `Community 3`, `Community 37`, `Community 5`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 16`, `Community 20`, `Community 21`, `Community 22`, `Community 26`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.269) - this node is a cross-community bridge._
- **Why does `memory_db()` connect `Community 3` to `Community 10`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `load_model_config()` connect `Community 3` to `Community 41`?**
