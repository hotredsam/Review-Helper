...
## Corpus Check
- 234 files · ~125,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2012 nodes · 4042 edges · 136 communities (131 shown, 5 thin omitted)
...
Cohesion: 0.10
Nodes (39): db(), detect_tech_in_clone(), detects_tech_from_manifests_with_word_boundaries(), is_word_char(), mentions(), refuses_symlinked_manifest_escaping_the_clone(), AuditEntry, key() (+31 more)
...
Cohesion: 0.12
Nodes (21): getModelStatus(), ModelEvent, ModelStatus, onModelEvent(), runModel(), UnavailableReason, getModelConfig(), ModelConfig (+13 more)
...
Cohesion: 0.15
Nodes (20): IntakeItem, learningIntake(), learningIntakeAnswer(), Subject, subjectCreate(), subjectDelete(), SubjectDetail, subjectGet() (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.15
Nodes (18): EmptyState(), EmptyStateProps, MainPane(), Props, MODES, ModeToggle(), Props, Sidebar() (+10 more)
...
Cohesion: 0.17
Nodes (21): Arc, IntakeItem, learning_intake(), learning_intake_answer(), LearningGate, subject_create(), subject_delete(), subject_get() (+13 more)
...
Cohesion: 0.19
Nodes (11): ModelBanner(), Tour(), TOUR_STEPS, tourSeen(), TourStep, App(), useStatusStore, claudeDown (+3 more)
...
Cohesion: 0.18
Nodes (9): Client, ThemeSwitcher(), backend, isThemeId(), ThemeId, ThemeMeta, THEMES, ThemeState (+1 more)
...
## Knowledge Gaps
- **544 isolated node(s):** `guard-commit.sh script`, `PreToolUse`, `recommendations`, `name`, `private` (+539 more)
...
- **Why does `init_connection()` connect `Community 10` to `Community 32`, `Community 34`, `Community 3`, `Community 36`, `Community 37`, `Community 6`, `Community 38`, `Community 7`, `Community 5`, `Community 43`, `Community 12`, `Community 14`, `Community 46`, `Community 15`, `Community 21`, `Community 22`, `Community 23`, `Community 25`?**
  _High betweenness centrality (0.261) - this node is a cross-community bridge._
- **Why does `http_client()` connect `Community 2` to `Community 3`, `Community 44`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `memory_db()` connect `Community 3` to `Community 10`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Are the 21 inferred relationships involving `init_connection()` (e.g. with `db()` and `db()`) actually correct?**
  _`init_connection()` has 21 INFERRED edges - model-reasoned connections that need verification._
